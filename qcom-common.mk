...
LOCAL_PATH := device/lenovo/qcom-common
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/permissions/com.qualcomm.wfd.permissions.xml:system/etc/permissions/com.qualcomm.wfd.permissions.xml \
    $(LOCAL_PATH)/permissions/interface_permissions.xml:system/etc/permissions/interface_permissions.xml \
    frameworks/native/data/etc/android.hardware.bluetooth_le.xml:system/etc/permissions/android.hardware.bluetooth_le.xml

# TODO
#   $(LOCAL_PATH)/permissions/btmultisim.xml:system/etc/permissions/btmultisim.xml \
...
# There are some missing permission from stock platform.xml. Maybe we should handle it in future?
# <!--[wzx-20131223],add fm  permission,begin-->
# <permission name="android.permission.FM_RADIO" >
#   <group gid="fm_radio" />
# </permission>
# <!--[wzx-20131223],add fm  permission,end-->
